    ...
    <div className="bg-seasalt flex w-full flex-col px-11.25 py-3.75 md:px-10 md:py-12.5 lg:px-28 lg:py-8">
      ...
      <div className="flex gap-x-1.5 md:gap-x-3 lg:gap-x-6">
        <Image
          ...
          height="4096"
          alt="left-cover"
          className="mt-1.25 h-45.5 w-1/2 rounded-xs object-cover object-center md:mt-6 md:h-auto md:max-w-115 md:rounded-md lg:max-w-121 xl:max-h-85 xl:max-w-200"
        />
        <Image
          src={rightImage}
          width="4096"
