...
const links = [
  ...
  { icon: Mail, href: 'www.gmail.com', label: 'Email' },
]
  ...
  return (
    <>
      <header className="relative flex items-center justify-between px-[22px] py-[11px] md:px-[15px] md:py-[30px] lg:px-24">
        ...
        <Navbar className="hidden md:flex" navItems={navItems} />
        ...
        {isNavOpen && (
          <>
            ...
            <div className="absolute top-0 left-0 z-20 flex w-full flex-col bg-white md:hidden">
              ...
              <Navbar className="flex flex-col gap-[10px] px-8 py-[4rem] md:hidden" navItems={navItems} />
