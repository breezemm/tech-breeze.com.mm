  ...
  return (
    <section id="contact" className="bg-seasalt mb-5 justify-center px-19.5 py-7.5">
      <div className="mx-auto w-full max-w-sm">
        <h1 className="text-xss mb-2 lg:mb-8 text-center lg:text-xl ">Contact us</h1>
        <div className="text-start lg:mx-auto">
          ...
          <form onSubmit={submit} className="text-seasalt flex flex-col items-center space-y-1.25 md:space-y-2 lg:space-y-4 ">
            <Input type="email" name="email" placeholder="Enter your email" required className="text-xss lg:text-sm lg:w-xs h-7.5 lg:h-10 " />
            <Input type="tel" name="phone" placeholder="Enter your phone number" required className="text-xss lg:text-sm lg:w-xs h-7.5 lg:h-10 "  />
